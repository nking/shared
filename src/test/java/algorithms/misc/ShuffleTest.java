...
public class ShuffleTest extends TestCase {
    ...
    public void testFisherYates_doubleArr() throws Exception {
        ...
        //
        // to make the comparisons easier, instead of encapsulating the arrays
        //  in a class with their own hashcode() and equals to use in a Set,
        //  will store them in Strings and a map to count the number of permutations
        //  generated by Shuffle.
        
        int[] a = new int[]{0, 1, 2, 3, 4, 5, 6};
        
        // each permutation p=1./5040
        // how many draws so that
