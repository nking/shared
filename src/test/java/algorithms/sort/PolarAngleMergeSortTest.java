...
public class PolarAngleMergeSortTest extends TestCase {
    ...
    public void testReduceToUniquePolarAngles() throws Exception {
        ...
        int nUsable = algorithms.sort.PolarAngleQuickSort.reduceToUniquePolarAngles(xx[0],
            yy[0], xx, yy, ap);
    ...
    public void testReduceToUniquePolarAngles2() throws Exception {
        ...
        int nUsable = algorithms.sort.PolarAngleQuickSort.reduceToUniquePolarAngles(xx[0], yy[0], xx, yy, ap);
    ...
    public void testSort1() {
        ...
        int nUsable = algorithms.sort.PolarAngleMergeSort.sort(2, 0, xx, yy);
        ...
        */
    	...
    	algorithms.sort.PolarAngleMergeSort.sort(2.0f, 0.0f, xx, yy, 1, xx.length - 1, polarAngle);
        for (int i=0; i < nUsable; i++) {
            assertTrue( Math.abs(expectedxx[i] - xx[i]) < 0.01);
            assertTrue( Math.abs(expectedyy[i] - yy[i]) < 0.01);
        }
    	...
    	nUsable = algorithms.sort.PolarAngleMergeSort.sort(2, 0, xx, yy);
    ...
    public void testSort2() {
        ...
        int nUsable = algorithms.sort.PolarAngleMergeSort.sort(2, 1, xx, yy);
    ...
    public void testSort3() {
        ...
        int nUsable = algorithms.sort.PolarAngleMergeSort.sort(3, 1, xx, yy);
    ...
    public void testSort() {
        ...
        algorithms.sort.PolarAngleMergeSort.sort(2, 0, xx, yy);
    ...
    public void testSortExceptions() {
        ...
        try {
            algorithms.sort.PolarAngleMergeSort.sort(2, 0, null, yy);
        ...
        threwException = false;
        try {
            algorithms.sort.PolarAngleMergeSort.sort(2, 0, xx, null);
        } catch (IllegalArgumentException e) {
            threwException = true;
        }
        assertTrue(threwException);
        ...
        int n = 0;
        try {
            n = algorithms.sort.PolarAngleMergeSort.sort(2, 0, new float[]{1.0f}, new float[]{1.0f});
            assertTrue(n == 1);
        } catch (IllegalArgumentException e) {
            threwException = true;
        }
