...
public class PolarAngleQuickSortTest extends TestCase {
    ...
    public void testSortCCWBy1stPoint() {
        ...
        int nR = MiscSorter.sortCCWBy1stPointLinear(x, y, reduceToUniqueAngles);
        assertEquals(5, nR);
        ...
        //sortCCWBy1stPointLinear
        double[] ex2 = new double[]{2, 7, 3, 2, 0};
        double[] ey2 = new double[]{0, 1, 2, 6, 2};
        x2 = new double[]{2, 7, 0, 2, 3, 2};
        y2 = new double[]{0, 1, 2, 2, 2, 6};
        nR = MiscSorter.sortCCWBy1stPointLinear(x2, y2, reduceToUniqueAngles);
        assertEquals(5, nR);
        double tol = 1E-7;
        for (int i = 0; i < nR; ++i) {
            assertTrue(Math.abs(ex2[i] - x2[i]) < tol);
            assertTrue(Math.abs(ey2[i] - y2[i]) < tol);
        }

        //sortCCWBy1stPoint
        x2 = new double[]{2, 7, 0, 2, 3, 2};
        y2 = new double[]{0, 1, 2, 2, 2, 6};
        double[] outAngle = new double[x2.length];
        double eps = 1E-3;
        nR = algorithms.sort.PolarAngleMergeSort.sortCCWBy1stPoint(x3, y3, outAngle, reduceToUniqueAngles, eps);
        assertEquals(5, nR);
        for (int i = 0; i < nR; ++i) {
            assertTrue(Math.abs(ex2[i] - x3[i]) < tol);
            assertTrue(Math.abs(ey2[i] - y3[i]) < tol);
        }
    }
    ...
    public void testReduceToUniquePolarAngles() throws Exception {
        ...
        int nUsable = algorithms.sort.PolarAngleQuickSort.reduceToUniquePolarAngles(
            points[0], points, ap);
    ...
    public void testReduceToUniquePolarAngles2() throws Exception {
        ...
        int nUsable = algorithms.sort.PolarAngleQuickSort.reduceToUniquePolarAngles(points[0],
            points, ap);
    ...
    public void testSort1() {
        ...
        int nUsable = algorithms.sort.PolarAngleQuickSort.sort(points[0], points);
        ...
        */
    	...
    	algorithms.sort.PolarAngleQuickSort.sortByPolarAngle(points, 1, points.length - 1, polarAngle);
        for (int i=0; i < nUsable; i++) {
            assertTrue( Math.abs(expectedxx[i] - points[i].getX()) < 0.01);
            assertTrue( Math.abs(expectedyy[i] - points[i].getY()) < 0.01);
        }
    	...
    	nUsable = algorithms.sort.PolarAngleQuickSort.sort(points[0], points);
    ...
    public void testSort1_2() {
        ...
        */
    	...
    	algorithms.sort.PolarAngleQuickSort.sortByPolarAngle(
    ...
    public void testSort() {
        ...
        algorithms.sort.PolarAngleQuickSort.sort(points[0], points);
    ...
    public void testSortExceptions() {
        ...
        try {
            PairInt[] t = null;
            algorithms.sort.PolarAngleQuickSort.sort(points[0], t);
    ...
    public void test0() throws Exception {
        ...
        algorithms.sort.PolarAngleMergeSort t = new PolarAngleMergeSort();
        assertNotNull(t);
    }
