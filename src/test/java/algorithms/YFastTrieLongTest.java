...
public class YFastTrieLongTest extends TestCase {
    ...
    public void test00() {
        ...
        YFastTrieLong bt = new YFastTrieLong(w);
    ...
    public void test1() throws Exception {
        ...
        for (int i = 0; i < n; ++i) {
            ...
            */
            if (index.intValue() > 0) {
                long prev = bt.predecessor(index);
